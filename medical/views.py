...
def download_file(request, card_id):
    ...
    iu = InstrumentUsed.objects.get(card_id = card)
    ai = AncillaryInstruments.objects.get(card_id = card)
    pp = PostProcedural.objects.get(card_id = card)
    fu = FollowUp.objects.get(card_id = card)
    ...
    for table in doc.tables:
        for i in table.rows:
            for j in i.cells:
                ...
                j.text = j.text.replace("[TABLE_PI1_3]", boolean_output(iu.table_pi1_3))
                j.text = j.text.replace("[TABLE_PI2_3]", boolean_output(iu.table_pi2_3))
                j.text = j.text.replace("[TABLE_PI3_3]", boolean_output(iu.table_pi3_3))
                j.text = j.text.replace("[TABLE_PI4_3]", boolean_output(iu.table_pi4_3))
                j.text = j.text.replace("[TABLE_MI1_3]", boolean_output(iu.table_mi1_3))
                j.text = j.text.replace("[TABLE_MI2_3]", boolean_output(iu.table_mi2_3))
                j.text = j.text.replace("[TABLE_MI3_3]", boolean_output(iu.table_mi3_3))
                j.text = j.text.replace("[TABLE_BI1_3]", boolean_output(iu.table_bi1_3))
                j.text = j.text.replace("[TABLE_BI2_3]", boolean_output(iu.table_bi2_3))
                j.text = j.text.replace("[TABLE_PI1_5]", boolean_output(iu.table_pi1_5))
                j.text = j.text.replace("[TABLE_PI2_5]", boolean_output(iu.table_pi2_5))
                j.text = j.text.replace("[TABLE_PI3_5]", boolean_output(iu.table_pi3_5))
                j.text = j.text.replace("[TABLE_PI4_5]", boolean_output(iu.table_pi4_5))
                j.text = j.text.replace("[TABLE_PI5_5]", boolean_output(iu.table_pi5_5))
                j.text = j.text.replace("[TABLE_PI6_5]", boolean_output(iu.table_pi6_5))
                j.text = j.text.replace("[TABLE_PI7_5]", boolean_output(iu.table_pi7_5))
                j.text = j.text.replace("[TABLE_PI8_5]", boolean_output(iu.table_pi8_5))
                j.text = j.text.replace("[TABLE_PI9_5]", boolean_output(iu.table_pi9_5))
                j.text = j.text.replace("[TABLE_PI10_5]", boolean_output(iu.table_pi10_5))
                j.text = j.text.replace("[TABLE_PI11_5]", boolean_output(iu.table_pi11_5))
                j.text = j.text.replace("[TABLE_PI12_5]", boolean_output(iu.table_pi12_5))
                j.text = j.text.replace("[TABLE_PI13_5]", boolean_output(iu.table_pi13_5))
                j.text = j.text.replace("[TABLE_PI14_5]", boolean_output(iu.table_pi14_5))
                j.text = j.text.replace("[TABLE_PI15_5]", boolean_output(iu.table_pi15_5))
                j.text = j.text.replace("[TABLE_PI16_5]", boolean_output(iu.table_pi16_5))
                j.text = j.text.replace("[TABLE_PI17_5]", boolean_output(iu.table_pi17_5))
                j.text = j.text.replace("[TABLE_MI1_5]", boolean_output(iu.table_mi1_5))
                j.text = j.text.replace("[TABLE_MI2_5]", boolean_output(iu.table_mi2_5))
                j.text = j.text.replace("[TABLE_MI3_5]", boolean_output(iu.table_mi3_5))
                j.text = j.text.replace("[TABLE_MI4_5]", boolean_output(iu.table_mi4_5))
                j.text = j.text.replace("[TABLE_MI5_5]", boolean_output(iu.table_mi5_5))
                j.text = j.text.replace("[TABLE_MI6_5]", boolean_output(iu.table_mi6_5))
                j.text = j.text.replace("[TABLE_MI7_5]", boolean_output(iu.table_mi7_5))
                j.text = j.text.replace("[TABLE_MI8_5]", boolean_output(iu.table_mi8_5))
                j.text = j.text.replace("[TABLE_BI1_5]", boolean_output(iu.table_bi1_5))
                j.text = j.text.replace("[TABLE_BI2_5]", boolean_output(iu.table_bi2_5))
                j.text = j.text.replace("[TABLE_BI3_5]", boolean_output(iu.table_bi3_5))
                j.text = j.text.replace("[TABLE_BI4_5]", boolean_output(iu.table_bi4_5))
                j.text = j.text.replace("[TABLE_BI5_5]", boolean_output(iu.table_bi5_5))
                j.text = j.text.replace("[TABLE_PI1_10]", boolean_output(iu.table_pi1_10))
                j.text = j.text.replace("[TABLE_PI2_10]", boolean_output(iu.table_pi2_10))
                j.text = j.text.replace("[TABLE_CA1]", boolean_output(iu.table_ca1))
                j.text = j.text.replace("[TABLE_CA2]", boolean_output(iu.table_ca2))
                j.text = j.text.replace("[TABLE_CA3]", boolean_output(iu.table_ca3))
                j.text = j.text.replace("[TABLE_CA4]", boolean_output(iu.table_ca4))
                j.text = j.text.replace("[TABLE_US]", boolean_output(iu.table_us))
                j.text = j.text.replace("[TABLE_AI1]", boolean_output(iu.table_ai1))
                j.text = j.text.replace("[TABLE_AI2]", boolean_output(iu.table_ai2))
                j.text = j.text.replace("[TABLE_AI3]", boolean_output(iu.table_ai3))
                j.text = j.text.replace("[TABLE_AI4]", boolean_output(iu.table_ai4))
                j.text = j.text.replace("[TABLE_RAD1]", boolean_output(iu.table_rad1))
                j.text = j.text.replace("[TABLE_RAD2]", boolean_output(iu.table_rad2))
                j.text = j.text.replace("[TABLE_RAD3]", boolean_output(iu.table_rad3))

                j.text = j.text.replace("[TACKER]", boolean_output(ai.tacker))
                j.text = j.text.replace("[CLIPS]", boolean_output(ai.clips))
                j.text = j.text.replace("[ST_LIN]", boolean_output(ai.staplers_l))
                j.text = j.text.replace("[ST_CIR]", boolean_output(ai.staplers_c))
                j.text = j.text.replace("[OTHER_AI]", boolean_output(ai.other))
                j.text = j.text.replace("[MONOPOLAR]", boolean_output(ai.monopolar))
                j.text = j.text.replace("[BIPOLAR]", boolean_output(ai.bipolar))
                j.text = j.text.replace("[ULTRASOUND]", boolean_output(ai.ultrasound))
                j.text = j.text.replace("[HED]", boolean_output(ai.high_energy_device))

                j.text = j.text.replace("[GENERIC_L1]", pp.generic_name_l1)
                j.text = j.text.replace("[DOSE_L1]", str(pp.dose_l1))
                j.text = j.text.replace("[UNIT_L1]", pp.unit_l1)
                j.text = j.text.replace("[GENERIC_L2]", pp.generic_name_l2)
                j.text = j.text.replace("[DOSE_L2]", str(pp.dose_l2))
                j.text = j.text.replace("[UNIT_L2]", pp.unit_l2)
                j.text = j.text.replace("[GENERIC_L3]", pp.generic_name_l3)
                j.text = j.text.replace("[DOSE_L3]", str(pp.dose_l3))
                j.text = j.text.replace("[UNIT_L3]", pp.unit_l3)
    ...
    for para in paras:
        ...
        para.text = para.text.replace("[DIAMETER]",iu.diameter)
        para.text = para.text.replace("[DIMENSION]", iu.dimension)
        para.text = para.text.replace("[OPTIC_DEGREE]", iu.optic_degree)
        para.text = para.text.replace("[MANUFACTURER]", iu.manufacturer)

        para.text = para.text.replace("[COMMENT_AI]", ai.comment)

        para.text = para.text.replace("[BROUGHT_ICU]", localize_yesno(pp.brought_ICU))
        para.text = para.text.replace("[START_ICU]", str(pp.start_ICU))
        para.text = para.text.replace("[END_ICU]", str(pp.end_ICU))
        para.text = para.text.replace("[DATE_DISCHARGE]", str(pp.datetime_discharge.strftime("%d-%m-%Y")))
        para.text = para.text.replace("[ADVERSE_EVENT]", localize_yesno(pp.adverse_event_noted))
        
        para.text = para.text.replace("[FOLLOW_DATE]", str(fu.date_followup.strftime("%d-%m-%Y")))
        para.text = para.text.replace("[ANY_AE]", localize_yesno(fu.any_AE))
